...
<div class="page-box">
	<ul class="page-body">
		...
		<c:if test="${PAGE.startPageNo >1 }">
			<li class="page-item"><a href="${rootPath}/todo?pageno=1" class="page-link">1</a></li>
			
			<li class="page-item">
			<a href="${rootPath}/todo?pageno=${PAGE.currentPageNo -1}" 
		...
		<c:forEach begin="${PAGE.startPageNo}" end="${PAGE.endPageNo}" var="page">
			...
			<a href="${rootPath}/todo?pageno=${page}"  class="page-link">${page}</a>
			</li>
		</c:forEach>
		...
		<li class="page-item">
			<a href="${rootPath}/todo?pageno=${PAGE.finalPageNo}"  
